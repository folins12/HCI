    ...
    button.addEventListener("click", function () {
      ...
      fetch('/reserve', {
        ...
        if (data.success) {
          ...
          // Aggiorna il numero di disponibilità in tempo reale
          var availabilityElement = document.querySelector(".availability[data-nursery-plant-id=\"".concat(nurseryPlantId, "\"]"));
          availabilityElement.textContent = data.new_availability;
        } else {
...
/******/ });
//# sourceMappingURL=reservations-36237b8e7428485f70cd.js.map