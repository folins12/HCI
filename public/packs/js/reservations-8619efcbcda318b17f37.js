...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/reservations.js");
/******/ })
/************************************************************************/
/******/ ({
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  reserveButtons.forEach(function (button) {
    button.addEventListener("click", function () {
      console.log("Button clicked!"); // Aggiungi questo log
      var nurseryPlantId = this.dataset.nurseryPlantId;
      console.log("Nursery Plant ID:", nurseryPlantId); // Aggiungi questo log
      ...
      fetch('/reserve', {
        ...
        console.log("Response data:", data); // Aggiungi questo log
        if (data.success) {
...
/******/ });
//# sourceMappingURL=reservations-8619efcbcda318b17f37.js.map